...
Scenario: Get algorithm
	Given I have a book whith following parametrs:
		| Id | Name  | Author  | Description  | Year | Articl  | BookPicture  | Count |
		| 1  | book1 | author1 | description1 | 2021 | articl1 | bookPicture1 | 1     |
	#When I'm getting book whith Id 1
	#Then The system returns book with following parametrs:
	#	| Id | Name  | Author  | Description  | Year | Articl  | BookPicture  | Count |
	#	| 1  | book1 | author1 | description1 | 2021 | articl1 | bookPicture1 | 1     |
